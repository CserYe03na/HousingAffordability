...
```
The mosaic pairs plot shows a clear pattern: higher-income households are much more likely to appear in the high-rent categories, while lower-income households cluster heavily in the cheapest rent brackets. This suggests that rent levels in NYC closely track economic capacity—households do not spread randomly across rent tiers but sort themselves according to what they can realistically afford.
